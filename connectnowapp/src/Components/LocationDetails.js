    ...
    <section>
      ...
      <table>
        ...
        <thead>
          <tr>
            <td>
              {location.mon_open} - {location.mon_close}
            </td>
            <td>
              {location.tue_open} - {location.tue_close}
            </td>
            <td>
              {location.wed_open} - {location.wed_close}
            </td>
            <td>
              {location.thu_open} - {location.thu_close}
            </td>
            <td>
              {location.fri_open} - {location.fri_close}
            </td>
            <td>
              {location.sat_open} - {location.sat_close}
            </td>
            <td>
              {location.sun_open} - {location.sun_close}
            </td>
          </tr>
        </thead>
      </table>
